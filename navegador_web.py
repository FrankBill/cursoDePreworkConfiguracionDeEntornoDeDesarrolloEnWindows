# Navegador web (en inglés: web browser) es un software que permite al usuario acceder a sitios web y visualizarlos. También conocido como navegador de internet, su nombre más común es simplemente “navegador”.

# Los navegadores funcionan gracias al protocolo HTTP, este protocolo es el que nos define cómo el texto, las imágenes, el audio, el video y todos los elementos que tenemos en nuestros sitios web van a ser transferidos, cómo van a viajar a través de internet y van a llegar hacia nosotros.
...
# Fn + F12
# Ctrl + shift + i
# Click derecho y seleccionar inspeccionar.

# Para tomar una captura de pantalla en Windows se puede usar:
